...
## Project Structure
    ...
    ├── testapiautostoryboa_72104  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_72104`
...
2. Clone this repo and `cd testapiautostoryboa_72104`
